...
import styles from './SalaryChange.module.css';
import {
  Accordion,
  AccordionDetails,
  AccordionSummary,
...
import SalaryValueInput from './components/SalaryValueInput';
          ...
          <form onSubmit={handleSubmitCalcSalary(onCalc)}>
            <TextField
              ...
              {...registerSalary('grossSalary', {
                valueAsNumber: true,
                onChange: (e) => {
                  localStorage.setItem('grossSalary', String(e.target.value));
                }
              })}
            />
            <SalaryValueInput
              name="nominalChange"
              defaultValue={Number(localStorage.getItem('nominalChange'))}
              onChange={(v: number) => localStorage.setItem('nominalChange', String(v))}
              textFieldSx={lightFieldStyle}
              register={registerSalary}
